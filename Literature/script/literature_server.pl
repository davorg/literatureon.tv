...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{LITERATURE_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{LITERATURE_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
literature_server.pl - Catalyst Testserver

=head1 SYNOPSIS

literature_server.pl [options]
